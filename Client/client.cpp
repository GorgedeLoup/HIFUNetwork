...
//    qDebug() << "&&&&&&&&&&&&&&&&&&&&&&&&&&";
//    qDebug() << "peerName:" << m_receiveSocket->peerName();
//    qDebug() << "peerAddress:" << m_receiveSocket->peerAddress();
//    qDebug() << "peerPort:" << m_receiveSocket->peerPort();
//    qDebug() << "localAddress:" << m_receiveSocket->localAddress();
//    qDebug() << "localPort:" << m_receiveSocket->localPort();
//    qDebug() << "&&&&&&&&&&&&&&&&&&&&&&&&&&";
}
